...
<ul class="login-switch nav nav-tabs nav-justified">
	<li class="nav-item">
		<a class="selectLogin nav-link active text-dark" aria-current="page" href="./login">사용자</a>
	</li>
	<li class="nav-item">
...
<!--  로그인 / 회원가입 버튼 start -->
<button class="btn btn-lg btn-login">로그인</button>
<a href="./join" class="btn btn-outline-secondary btn-lg btn-signup" type="button">회원가입</a>
<!--  로그인 / 회원가입 버튼 end -->
