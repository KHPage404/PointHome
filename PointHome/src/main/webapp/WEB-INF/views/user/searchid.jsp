...
<!-- 로고 운칠기삼 end -->
<h1 class="text-center text-dark searchid-title">아이디 찾기</h1>


<!-- 사용자 / 제휴사 로그인 스위치 start -->
<ul class="login-switch nav nav-tabs nav-justified">
	<li class="nav-item">
		<a class="selectLogin nav-link active text-dark" aria-current="page" href="./searchid">사용자</a>
	</li>
	<li class="nav-item">
		<a class="selectLogin nav-link text-secondary" href="/partner/searchid">제휴사</a>
	</li>
</ul>
<!-- 사용자 / 제휴사 로그인 스위치 end -->
